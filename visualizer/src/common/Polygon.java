...
public class Polygon { // closed shape of a certain structure type
	
	public static final String TUMOR_NAME = "Tumor";
	public static final String[] STRUCTURES = new String[] {TUMOR_NAME, "CA_CHA", "PV_SMV", "SMA"};
